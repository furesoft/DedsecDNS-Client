...
namespace DedSecDns_Client.Core
{
    public class HashFile
    {
        ...
        private const byte Chars = 91;

        // Number of Valid Characters (ASCII character range Decimal 32(Space)-122(z))
        private const int RecordOffset = 4;
        ...
        private bool flag;
        private byte[] IndexBlock = new byte[91 * 8];
        private int IndexError, Difference, CurrentKey = 0;
        private uint IndexPosition = 0, IndexOffset = 0;
        private string key, kvalue;
        private ushort KeySize = 50;
        private Byte[] LastKeyBytes, KeyBytes;
        private uint LastPosition = 0;
        private uint NumberOfKeys = 0;
        private ushort RecordSize;

        // Index Stream
        private String StringLastError = "";

        private ushort ValueSize = 50;
